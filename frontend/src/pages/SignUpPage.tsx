...
import { ArrowLeft, Eye, EyeOff, ChevronRight, Sun, Moon, GraduationCap, Briefcase } from 'lucide-react';
      ...
      <main className="login-main signup-main">
        ...
        >
          ...
          <p className="login-subheading">
            Join the ESISA career network as a student or recruiter.
          </p>
          ...
          <div className="signup-role-selector">
            ...
            <button
              type="button"
              className={`signup-role-btn ${role === 'recruiter' ? 'signup-role-btn--active' : ''}`}
          ...
          <div className="login-divider">
            ...
            <span className="login-divider-text">or fill in the form</span>
            <div className="login-divider-line" />
          </div>
            ...
            <div className="login-field">
              ...
              <div className="login-input-wrap">
                <span className="login-input-icon signup-icon-text">
                  <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke={darkMode ? '#94A3B8' : '#64748B'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                >
                  <div className="signup-row">
                    ...
                    <div className="login-field">
                      ...
                      <div className="login-input-wrap">
                        <span className="login-input-icon signup-icon-text">
                          <GraduationCap size={18} color={darkMode ? '#94A3B8' : '#64748B'} />
                        </span>
                        <input
                          id="signup-program"
                          type="text"
                ...
                >
                  <div className="signup-row">
                    ...
                    <div className="login-field">
                      ...
                      <div className="login-input-wrap">
                        <span className="login-input-icon signup-icon-text">
                          <Briefcase size={18} color={darkMode ? '#94A3B8' : '#64748B'} />
                        </span>
                        <input
                          id="signup-jobtitle"
                          type="text"
