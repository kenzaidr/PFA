...
export default function DashboardOverview() {
  ...
  const navItems = [
    { label: 'Vue d\'ensemble', icon: <BarChart3 size={18} />, path: '/dashboard/overview', active: true },
    { label: 'Apprentissage', icon: <BookOpen size={18} />, path: '/dashboard/learning', active: false },
    ...
    <div className="dash-root" data-theme={darkMode ? 'dark' : 'light'}>
      ...
      <div className="dash-main">
        ...
        <main className="dash-content">
          ...
          <motion.div className="dash-welcome-banner" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
            ...
            <div className="dash-welcome-illustration">
              <div className="dash-illustration-circle">
                <div className="dash-illustration-score">87<span>%</span></div>
                <p className="dash-illustration-label">Score Global</p>
              </div>
            </div>
          </motion.div>
          ...
          {/* Two columns: Activity chart + Recent activity */}
          <div className="dash-two-cols">
            ...
            <motion.div className="dash-chart-card" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
              <div className="dash-section-header" style={{ marginBottom: '1rem' }}>
                <div>
                  <h2 className="dash-section-title">Activité de la semaine</h2>
                  <p className="dash-section-sub">Votre progression quotidienne</p>
                </div>
              </div>
              <div className="dash-bar-chart">
                {weekProgress.map((day, i) => (
                  <div key={day.day} className="dash-bar-col">
                    <motion.div
                      className="dash-bar"
                      initial={{ height: 0 }}
                    ...
                    />
                    <span className="dash-bar-label">{day.day}</span>
                  </div>
                ))}
              </div>
            </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.4 }}>
            <div className="dash-section-header">
              ...
              <button className="dash-view-more">
