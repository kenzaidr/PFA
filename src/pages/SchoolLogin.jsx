...
export default function SchoolLogin() {
  ...
  const submit = (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      navigate('dashboard-school', { role: 'school', name: form.email.split('@')[0] });
    }, 1400);
  };
      ...
      <div className="relative w-full max-w-[440px]">
        ...
        <div className="glass gradient-border rounded-3xl overflow-hidden">
          ...
          <div className="p-8 bg-gradient-to-b from-emerald-500/5 to-transparent border-b border-white/[0.06]">
            ...
            <p className="text-slate-400 text-sm">Connecte-toi pour accéder au suivi des cohortes et de l'employabilité.</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="p-3 rounded-xl bg-white/[0.02] border border-emerald-500/20">
                ...
                <div className="text-xs text-slate-400 font-medium">Suivi Cohorte</div>
              </div>
              <div className="p-3 rounded-xl bg-white/[0.02] border border-emerald-500/20">
                <div className="text-lg mb-1">📈</div>
                <div className="text-xs text-slate-400 font-medium">Employabilité</div>
              </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button type="submit" disabled={loading}
                className={`w-full py-3.5 rounded-2xl text-sm font-semibold text-white cursor-pointer flex items-center justify-center gap-2 mt-6 bg-gradient-to-r from-emerald-600 to-teal-600 hover:shadow-lg hover:shadow-emerald-500/20 transition-all ${loading ? 'opacity-70' : ''}`}>
                {loading
